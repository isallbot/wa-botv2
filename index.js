/*
]=====> BOT-ISALL ID <=====[ ]=====> YT BOT-ISALL CHANNEL <=====[ ]=====> 085559240360 <=====[
*/
const {
   WAConnection,
   MessageType,
...
client.sendMessage(from, ''+tes+'\n\n_By : ⸸BOT-ISALL⸸Panutanque._', text, { quoted: mek })
await limitAdd(sender)
break
				case 'tts':
				if (isBanned) return reply(ind.baned())
                ...
                var gh = body.slice(12)
					...
					var wm = gh.split("&")[1];
					const pref = `yang mau dijadiin quote apaan, titit?\n\ncontoh : ${prefix}bikinquote aku bukan boneka & Kata BOT-ISALL`
...
*/				
            	case 'mining':
                      ...
                      reply(`karena BOT-ISALL baik Bot memberikan ${one}Xp >_<`)
                      }else{
...
*/					
                case 'indohot':
				 client.updatePresence(from, Presence.composing)
					if (!isOwner) return reply('FITUR KHUSUS BOT-ISALL')				
